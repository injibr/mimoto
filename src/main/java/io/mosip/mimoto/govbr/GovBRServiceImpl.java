...
public class GovBRServiceImpl implements GovBRService {
    ...
    @Override
    public GovBRUserProfileResponse getUserProfile(String code, String codeVerifier, String redirectUri) throws GovBRException {
        try {
            logger.info("Getting token from GovBR");
            TokenResponseDTO tokenResponse = getToken(code, codeVerifier, redirectUri);
    ...
    public TokenResponseDTO getToken(String code, String codeVerifier, String redirectUri) {
        ...
        map.add("redirect_uri", redirectUri != null ? redirectUri : configRedirectUri);
